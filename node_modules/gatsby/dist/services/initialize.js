...
async function initialize({
  ...
  process.env.GATSBY_HOT_LOADER = (0, _getReactHotLoaderStrategy.getReactHotLoaderStrategy)();
  ...
  if (config && config.flags) {
    ...
    const {
      enabledConfigFlags,
      message
    } = (0, _handleFlags.default)(availableFlags, config.flags); //  set process.env for each flag
